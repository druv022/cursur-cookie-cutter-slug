...
Invoke the .cursor/skills/incremental-implementation/SKILL.md skill alongside .cursor/skills/test-driven-development/SKILL.md.
...
3. **Plan if needed.** If there is no `tasks/plan.md`, invoke .cursor/skills/planning-and-task-breakdown/SKILL.md to generate one.
...
If any step fails, follow the .cursor/skills/debugging-and-error-recovery/SKILL.md skill.
